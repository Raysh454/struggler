...
import 'package:flutter/material.dart' show Colors, TextStyle, TextPainter, TextSpan, Canvas, Offset, Paint;
...
class DialogueBubble extends PositionComponent {
  ...
  void render(Canvas canvas) {
    ...
    final paint = Paint()
      ..color = const Color(0xAA000000).withOpacity(0.6 * opacity);
