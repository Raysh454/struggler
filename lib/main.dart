...
class _TouchControls extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Positioned.fill(
      child: // Wrap both sections in a Stack if they aren't already, 
// or place these side-by-side in your main layout build method.
Stack(
  children: [
    
    // ==========================================
    // 1. TOP-RIGHT CORNER: UTILITY ROW
    // ==========================================
    Align(
      alignment: Alignment.topRight,
      child: Padding(
        padding: const EdgeInsets.all(20), // Keeps it clean from the screen edges
        child: Row(
    ...
    // ==========================================
    // 2. BOTTOM-RIGHT CORNER: COMBAT CLUSTER
    // ==========================================
    Align(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            // Left column of the cluster: DODGE
            Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                _ControlButton(
